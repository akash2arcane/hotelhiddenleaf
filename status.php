...
if(isset($_POST['accept']))
{
       ...
       echo '<META HTTP-EQUIV="Refresh" CONTENT="0; URL=admin.php#event">';
   }
   else if(isset($_POST['pay']))
   {
       $query="UPDATE events SET Status ='paid' WHERE SNo='$Sno'";
       mysqli_query($con,$query);
        echo '<META HTTP-EQUIV="Refresh" CONTENT="0; URL=appointment.php#event">';
   }
...
else if(isset($_POST['delete']))
   {
     ...
     $query="DELETE FROM events WHERE SNo ='$Sno'";
       mysqli_query($con,$query);
        echo '<META HTTP-EQUIV="Refresh" CONTENT="0; URL=admin.php#E-expired">';
   }
else {
