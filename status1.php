...
if(isset($_POST['accept']))
{
    ...
    echo '<META HTTP-EQUIV="Refresh" CONTENT="0; URL=admin.php#room">';
     ...
     while($row=mysqli_fetch_assoc($num))
{
      ...
      {       
       ...
       mysqli_query($con,$query);
        echo '<META HTTP-EQUIV="Refresh" CONTENT="0; URL=appointment.php#room">';
   }
     ...
     while($row=mysqli_fetch_assoc($num))
{
     ...
     mysqli_query($con,$avail);
    mysqli_query($con,$query);
    echo '<META HTTP-EQUIV="Refresh" CONTENT="0; URL=admin.php#expired">';
       ...
       $query="DELETE FROM room WHERE SNo ='$Sno'";
    mysqli_query($con,$query);
    echo '<META HTTP-EQUIV="Refresh" CONTENT="0; URL=admin.php#rejected">';
   ...
   { $i=0;
    while($i<$Rno){
     ...
     echo "<script>alert('Room is added'); window.location.href='admin.php#add'; </script>";
